---
title: "Compile, aggregate, and plot estimates" 
...
It requires a table of all individual expert estimates (**Estimates_tidy.csv**; excluded from the archive). 
...
Creates pointrange plots of the aggregated (mean) best guess, lowest, and highest estimates of probability of persistence given a table of mean estimates (**Mean_persistence.csv**).  

Provided to experts as part of the review/revision stage of expert elicitation. This is also the same figure used as Fig. B-2 in the manuscript appendix.
