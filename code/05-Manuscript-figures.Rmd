...
Plots Pareto frontier curves based on results of complementarity analysis
...
```{r Fig2, warning = FALSE, fig.show = 'hide'}
...
```{r Fig2ins, echo=FALSE, warning = FALSE}
# Displays plot in R markdown document
barplot.1115
```
...
```{r Fig3, warning = FALSE, fig.show = 'hide'}
# Read in data
results.best <- read.csv(paste0(results, "/Complementarity_best.csv"))
results.bestben <- read.csv(paste0(results, "/Complementarity_best_Benefits.csv")) 
...
```{r Fig3ins, echo=FALSE, warning = FALSE}
# Displays plot in R markdown document
optcurve.best.ann
```
...
```{r FigB1, warning = FALSE, fig.show = 'hide'}
# Read in data
results.bestben <- read.csv(paste0(results, "/Complementarity_best_Benefits.csv"))  
results.best <- read.csv(paste0(results, "/Complementarity_best.csv")) 
...
```{r FigB1ins, echo = FALSE, warning = FALSE}
# Displays plot in R markdown document
optcurve.bestben
```
...
Figure B-2 is created in **ExpertPlots.Rmd**.

### Figures B-3 and B-4

```{r uncrtnsetup, message = FALSE, warning = FALSE, fig.show = 'hide'}
# Read in data
results.low <- read.csv(paste0(results, "/Complementarity_low.csv"))
results.high <- read.csv(paste0(results, "/Complementarity_high.csv"))

opt.high <- read.csv(paste0(results, "/Uncertainty_high.csv"))
opt.low <- read.csv(paste0(results, "/Uncertainty_low.csv"))

results.best <- read.csv(paste0(results, "/Complementarity_best.csv")) # results using 
```

Figure B-3 Most optimistic scenario
```{r FigB3, message = FALSE, warning = FALSE, fig.show = 'hide'}
...
```{r FigB3ins, warning = FALSE, echo = FALSE}
# Displays plot in R markdown document
optcurve.high
```

Figure B-4 Most pessimistic scenario
```{r FigB4, message = FALSE, warning = FALSE, fig.show = 'hide'}
...
```{r FigB4ins, warning = FALSE, echo = FALSE}
# Displays plot in R markdown document
optcurve.low
```
...
```{r FigB5, warning = FALSE, message = FALSE, fig.show = 'hide'}
...
results.0disc <- read.csv(paste0(results, "/Complementarity_0disc.csv"))
results.0disc <- results.0disc %>%
  mutate(disc_rate = 0, 
         labels = ifelse(number_of_species>8,1,0))

results.7disc <- read.csv(paste0(results, "/Complementarity_7disc.csv"))
...
```{r FigB5ins, warning = FALSE, echo = FALSE}
# Displays plot in R markdown document
optcurve.disc
```
