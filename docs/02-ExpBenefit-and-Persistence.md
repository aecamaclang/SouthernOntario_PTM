Calculate expected benefit and probability of persistence
================
Abbey Camaclang
2025-09-24
...
Requires **Mean_benefits.csv** and **Mean_baseline.csv**, and a
...
Creates plots of the best guess, lowest, and highest estimates of the
expected probability of persistence given a table feasibility-weighted
mean estimates (**ExpPerformance.csv**).
